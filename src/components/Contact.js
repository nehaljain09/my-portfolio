...
function Contact() {
  ...
  return (
    <div
      id="contact"
      className="p-[2rem] flex-col sm:px-[1.25rem] mt-10 ml-10 mr-10 flex tm:py-0 sm:py-0 sm:mt-14 tm:flex-col gap-[40px] sm:gap-[20px] tm:gap-[20px] sm:flex-col"
    >
      ...
      <div className="flex justify-center">
        <form
          className="flex flex-col gap-4 tm:w-full sm:w-full lg:w-[88%] w-[100%]"
          ref={form}
          onSubmit={sendEmail}
        >
          <label>Name</label>
      ...
      <div className="flex justify-center items-center font-[350] text-[0.6rem] leading-loose sm:text-[1rem]  tm:text-[1rem]">
        {" "}
        Copyright © 2023
        <span className="font-[500]">&nbsp;Nehal&nbsp; </span>
        All Rights Reserved
      </div>
    </div>
  );
